...
export class MyProfilePage implements OnInit {
 ...
 url: any;
  ...
  this.gaddress=res.val().guardian_current_address;
    ...
    if( isMobile.any() ){
      document.getElementById('leftbar3').style.left="-270px";
    }else{
      document.getElementById('leftbar3').style.left="0px";
    }
  }
  ...
  showleft(){
    if(document.getElementById('leftbar3').style.left=="-270px"){
      document.getElementById('leftbar3').style.left="0px";
    }else{
      document.getElementById('leftbar3').style.left="-270px";
    }
  ...
  hideleft(){
    if(document.getElementById('leftbar3').style.left=="0px"){
      document.getElementById('leftbar3').style.left="-270px";
    }
