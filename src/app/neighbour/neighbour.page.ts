...
public profile_url:string;
  ...
  ngOnInit() {
    ...
    if( isMobile.any() ){
      document.getElementById('leftbar4').style.left="-270px";
    }else{
      document.getElementById('leftbar4').style.left="0px";
    }
  }
...
alert("fds");
  ...
  showleft(){
    if(document.getElementById('leftbar4').style.left=="-270px"){
      document.getElementById('leftbar4').style.left="0px";
    }else{
      document.getElementById('leftbar4').style.left="-270px";
    }
  ...
  hideleft(){
    if(document.getElementById('leftbar4').style.left=="0px"){
      document.getElementById('leftbar4').style.left="-270px";
    }
}
